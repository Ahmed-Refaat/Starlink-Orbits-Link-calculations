...
interface AppState {
  ...
  hudVisible: boolean;
  satelliteCategory: string; // Celestrak group key, e.g. 'starlink'
  ...
  setSatelliteCategory: (category: string) => void;
}
...
export const useAppStore = create<AppState>((set) => ({
  ...
  setSatelliteCategory: (category) => set({ satelliteCategory: category, satellitesLoaded: false }),
}));
