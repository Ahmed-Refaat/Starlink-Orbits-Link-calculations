...
export default function Satellites() {
  ...
  // Only apply altitude filter for Starlink — other categories are at different altitudes
  const effectiveAltitudeFilter = altitudeFilter && satelliteCategory === 'starlink';
  ...
  useEffect(() => {
    ...
    console.log(`Showing ${filteredSatrecs.length} satellites${effectiveAltitudeFilter ? ` (filtered from ${totalCount})` : ''}`);
  ...
  }, [tleData, effectiveAltitudeFilter, mesh]);
