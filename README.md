# Starlink Orbits & Link Calculations

Real-time 3D satellite tracker and mission control dashboard. Track satellites across multiple constellations (Starlink, GPS, GLONASS, Galileo, BeiDou, OneWeb, and more), monitor live dish telemetry, visualize ground stations, and watch satellite handoffs — all computed from publicly available data. Built with Next.js, React Three Fiber, and Three.js.

**Maintained by [Ahmed Refaat](https://github.com/Ahmed-Refaat)**  
_Originally forked from [juliensimon/starlink-viz](https://github.com/juliensimon/starlink-viz) — extended with multi-constellation support, Celestrak category selector, and production deployment improvements._
...
**Ahmed Refaat** — [@Ahmed-Refaat](https://github.com/Ahmed-Refaat)

## License

Apache License 2.0 — see [LICENSE](LICENSE) for details.

> Originally forked from [juliensimon/starlink-viz](https://github.com/juliensimon/starlink-viz) (MIT).  
> This fork adds multi-constellation satellite support, Celestrak category selector, production PM2 deployment, and various bug fixes.
